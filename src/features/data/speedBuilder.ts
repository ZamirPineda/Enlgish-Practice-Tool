...
export const speedBuilderRounds: SpeedBuilderRound[] = [
  ...
  {
    id: "a2-interview-2",
    sentence: "In my last role I supported customers during busy periods",
    tags: ["Interview", "Work"],
    level: "A2",
  },
  {
    id: "a2-interview-3",
    sentence: "I learn quickly when I receive clear feedback",
  ...
  },
  {
    id: "b1-interview-3",
    sentence:
      "I learned to ask clarifying questions before committing to a timeline",
    tags: ["Interview", "Reflection"],
    level: "B1",
  },
  {
    id: "b1-reflection-1",
    sentence:
      "Looking back I would involve the design team earlier in the process",
  ...
  },
  {
    id: "b1-leadership-2",
    sentence:
      "I stayed calm and helped the team reset priorities during the outage",
    tags: ["Leadership", "Interview", "Reflection"],
    level: "B1",
  },
  {
    id: "b1-work-2",
  ...
  },
  {
    id: "b2-strategy-1",
    sentence:
      "Our proposal balances short term wins with long term sustainability",
    tags: ["Strategy", "Business"],
    level: "B2",
  },
  {
  ...
  },
  {
    id: "b2-analysis-1",
    sentence:
      "These metrics reveal a steady decline in activation after signup",
    tags: ["Analysis", "Data"],
    level: "B2",
  },
  {
  ...
  },
  {
    id: "b2-quality-1",
    sentence:
      "We documented the regression so future releases remain predictable",
  ...
  },
  {
    id: "c1-risk-1",
    sentence:
      "Unless we diversify suppliers the operation remains dangerously exposed",
  ...
  },
  {
    id: "c1-governance-1",
    sentence:
      "The committee insisted that every exception be formally documented",
  ...
  },
  {
    id: "c1-research-1",
    sentence:
      "The findings were compelling albeit limited by a narrow sample size",
  ...
  },
  {
    ...
    sentence:
      "Reconciling conflicting stakeholder expectations required careful sequencing",
  ...
  },
  {
    id: "c1-ethics-1",
    sentence:
      "We cannot justify collecting sensitive data without explicit consent",
    tags: ["Ethics", "Policy"],
    level: "C1",
  },
  {
    id: "c1-change-1",
    sentence:
      "The reorganization succeeded because managers communicated the rationale transparently",

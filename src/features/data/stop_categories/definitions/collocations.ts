...
export const collocationsData: StopData = {
  A: {
    Collocations: [
      {
        word: "Abject poverty",
        ipa: "/ˈæbdʒɛkt ˈpɒvərti/",
        translation: "Pobreza extrema",
        level: "C2",
        definition: "Extremely poor living conditions.",
        examSentence: "Millions live in abject poverty.",
      },
      {
        word: "Absolute beginner",
        ipa: "/ˈæbsəluːt bɪˈɡɪnər/",
        translation: "Principiante absoluto",
        level: "B1",
        definition: "Someone with no experience at all.",
        examSentence: "The course is for absolute beginners.",
      },
      {
        word: "Academic achievement",
        ipa: "/ˌækəˈdɛmɪk əˈtʃiːvmənt/",
        translation: "Logro académico",
        level: "B2",
        definition: "Success in school or university.",
        examSentence: "Her academic achievement was recognized.",
      },
      {
        word: "Accept responsibility",
        ipa: "/əkˈsɛpt rɪˌspɒnsɪˈbɪlɪti/",
        translation: "Aceptar responsabilidad",
        level: "B2",
        definition: "To admit you are responsible.",
        examSentence: "He accepted responsibility for the error.",
      },
      {
      ...
      },
      {
        word: "Admit defeat",
        ipa: "/ədˈmɪt dɪˈfiːt/",
        translation: "Admitir la derrota",
        level: "C1",
        definition: "To accept you cannot win.",
        examSentence: "He refused to admit defeat.",
      },
      {
        word: "Adverse effect",
        ipa: "/ˈædvɜːrs ɪˈfɛkt/",
      ...
      {
        word: "Afraid of the dark",
        ipa: "/əˈfreɪd əv ðə dɑːrk/",
        translation: "Miedo a la oscuridad",
        level: "A2",
        definition: "Frightened by lack of light.",
        examSentence: "The child is afraid of the dark.",
      },
      {
      ...
      },
      {
        word: "All day long",
        ipa: "/ɔːl deɪ lɒŋ/",
        translation: "Todo el santo día",
        level: "B1",
        definition: "For the entire day.",
        examSentence: "He complained all day long.",
      },
      {
        word: "Alleviate pain",
        ipa: "/əˈliːvieɪt peɪn/",
        ...
        level: "C2",
        definition: "To make pain less severe.",
        examSentence: "This medicine helps alleviate pain.",
      },
      {
        word: "Alternative medicine",
        ipa: "/ɔːlˈtɜːrnətɪv ˈmɛdɪsɪn/",
        translation: "Medicina alternativa",
        level: "B2",
        definition: "Non-traditional medical treatments.",
        examSentence: "She practices alternative medicine.",
      },
      {
        word: "Ambiguous answer",
      ...
      },
      {
        word: "Ample time",
        ipa: "/ˈæmpl taɪm/",
        translation: "Tiempo de sobra",
        level: "C1",
        definition: "More than enough time.",
        examSentence: "You have ample time to finish.",
      },
      {
      ...
      },
      {
        word: "Annual leave",
        ipa: "/ˈænjuəl liːv/",
        translation: "Vacaciones anuales",
        level: "B2",
        definition: "Paid time off work.",
        examSentence: "I have 20 days of annual leave.",
      },
      {
        ...
        level: "A1",
        definition: "Pick up a call.",
        examSentence: "Can you answer the phone?",
      },
      {
        word: "Apologize profusely",
        ipa: "/əˈpɒlədʒaɪz prəˈfjuːsli/",
        translation: "Disculparse profusamente",
        level: "C2",
        definition: "To say sorry many times.",
        examSentence: "He apologized profusely for being late.",
      },
      {
      ...
      },
      {
        ...
        level: "B2",
        definition: "Computer systems stimulating human intelligence.",
        examSentence: "AI is changing the world.",
      },
      {
        word: "Ask a favor",
        ipa: "/ɑːsk ə ˈfeɪvər/",
      ...
      {
        word: "Assess the situation",
        ipa: "/əˈsɛs ðə ˌsɪtjuˈeɪʃən/",
        translation: "Evaluar la situación",
        level: "C1",
        definition: "To judge or decide about a situation.",
        examSentence: "We need to assess the situation first.",
      },
      {
        word: "Attach importance",
        ipa: "/əˈtætʃ ɪmˈpɔːrtəns/",
        translation: "Dar importancia",
        level: "B2",
        definition: "To consider something important.",
        examSentence: "I attach great importance to honesty.",
      },
      {
        ...
        level: "A2",
        definition: "Go to a meeting.",
        examSentence: "I have to attend a meeting.",
      },
      {
        word: "Available resources",
      ...
      },
      {
        word: "Awful lot",
        ipa: "/ˈɔːfʊl lɒt/",
        translation: "Un montón",
        level: "B2",
        definition: "A very large amount (informal).",
        examSentence: "That's an awful lot of money.",
      },
    ],
  },
  B: {
    Collocations: [
      {
        ...
        level: "A2",
        definition: "A negative repeated behavior.",
        examSentence: "Smoking is a bad habit.",
      },
      {
        word: "Badly needed",
        ipa: "/ˈbædli ˈniːdɪd/",
      ...
      },
      {
        ...
        level: "B1",
        definition: "Eating right amounts of food groups.",
        examSentence: "Eat a balanced diet for health.",
      },
      {
        word: "Bare essentials",
        ipa: "/bɛər ɪˈsɛnʃəlz/",
        translation: "Lo más básico",
        level: "C1",
        definition: "Only the most necessary things.",
        examSentence: "We packed only the bare essentials.",
      },
      {
        word: "Basic necessity",
        ipa: "/ˈbeɪsɪk nɪˈsɛsɪti/",
        translation: "Necesidad básica",
        level: "B2",
        definition: "Something you must have.",
        examSentence: "Water is a basic necessity.",
      },
      {
        word: "Bear a resemblance",
      ...
      },
      {
        word: "Best practice",
        ipa: "/bɛst ˈpræktɪs/",
        translation: "Mejor práctica",
        level: "C1",
        definition: "The most effective method.",
        examSentence: "Follow industry best practices.",
      },
      {
        word: "Big deal",
        ipa: "/bɪɡ diːl/",
      ...
      },
      {
        word: "Bitter enemy",
        ipa: "/ˈbɪtər ˈɛnəmi/",
        translation: "Enemigo acérrimo",
        level: "C1",
        definition: "Someone you hate very much.",
        examSentence: "They are bitter enemies.",
      },
      {
        word: "Bitterly disappointed",
        ipa: "/ˈbɪtərli ˌdɪsəˈpɔɪntɪd/",
        translation: "Amargamente decepcionado",
        level: "B2",
        definition: "Very sad about a result.",
        examSentence: "He was bitterly disappointed.",
      },
      {
        word: "Blank stare",
        ipa: "/blæŋk stɛər/",
        translation: "Mirada perdida",
        level: "B2",
        definition: "Look with no expression.",
        examSentence: "She gave me a blank stare.",
      },
      {
        word: "Blazing sun",
        ipa: "/ˈbleɪzɪŋ sʌn/",
      ...
      },
      {
        ...
        ipa: "/ˈblɪsfʊli ˈɪɡnərənt/",
        translation: "Felizmente ignorante",
        level: "C2",
        definition: "Unaware of unpleasant facts.",
        examSentence: "He remained blissfully ignorant.",
      },
      {
        word: "Block of flats",
        ipa: "/blɒk əv flæts/",
      ...
      },
      {
        ...
        ipa: "/bluː skaɪ ˈθɪŋkɪŋ/",
        translation: "Pensamiento creativo",
        level: "C1",
        definition: "Creative ideas not limited by current reality.",
        examSentence: "We need some blue sky thinking.",
      },
      {
        word: "Board meeting",
        ipa: "/bɔːrd ˈmiːtɪŋ/",
      ...
      },
      {
        ...
        ipa: "/buːst ˈkɒnfɪdəns/",
        translation: "Aumentar la confianza",
        level: "B2",
        definition: "Make someone feel more sure.",
        examSentence: "Success boosts confidence.",
      },
      {
        word: "Break a habit",
        ipa: "/breɪk ə ˈhæbɪt/",
        translation: "Romper un hábito",
        level: "B1",
        definition: "Stop doing something routine.",
        examSentence: "It's hard to break a habit.",
      },
      {
        word: "Break a promise",
        ipa: "/breɪk ə ˈprɒmɪs/",
        translation: "Romper una promesa",
        level: "B1",
        definition: "Fail to keep a word.",
        examSentence: "Never break a promise.",
      },
      {
        word: "Break the law",
        ipa: "/breɪk ðə lɔː/",
      ...
      },
      {
        word: "Break the news",
        ipa: "/breɪk ðə njuːz/",
        translation: "Dar la noticia",
        level: "C1",
        definition: "Tell someone something new/bad.",
        examSentence: "Who will break the news to her?",
      },
      {
        word: "Brief chat",
        ipa: "/briːf tʃæt/",
      ...
      },
      {
        word: "Broken home",
        ipa: "/ˈbroʊkən hoʊm/",
        translation: "Hogar roto",
        level: "C1",
        definition: "Family with divorced parents.",
        examSentence: "He comes from a broken home.",
      },
      {
  ...
  C: {
    Collocations: [
      ...
      },
      {
        word: "Cast doubt",
        ipa: "/kɑːst daʊt/",
        translation: "Sembrar dudas",
        level: "C2",
        definition: "Make something seem uncertain.",
        examSentence: "New evidence cast doubt on the verdict.",
      },
      {
        word: "Casual acquaintance",
        ipa: "/ˈkæʒjuəl əˈkweɪntəns/",
        translation: "Conocido casual",
        level: "C1",
        definition: "Someone you know slightly.",
        examSentence: "He is just a casual acquaintance.",
      },
      {
        word: "Catch a cold",
        ipa: "/kætʃ ə koʊld/",
      ...
      },
      {
        word: "Change course",
        ipa: "/tʃeɪndʒ kɔːrs/",
        translation: "Cambiar el rumbo",
        level: "B2",
        definition: "Go a different way.",
        examSentence: "The ship changed course.",
      },
      {
      ...
      },
      {
        word: "Come to terms",
        ipa: "/kʌm tu tɜːrmz/",
        translation: "Aceptar/Asimilar",
        level: "C2",
        definition: "Accept a difficult situation.",
        examSentence: "She came to terms with her loss.",
      },
      {
        word: "Comfort food",
        ipa: "/ˈkʌmfərt fuːd/",
        translation: "Comida reconfortante",
        level: "C1",
        definition: "Food that makes you feel good.",
        examSentence: "Soup is my comfort food.",
      },
      {
      ...
      },
      {
        ...
        ipa: "/kəmˈpliːtli ˈdɪfrənt/",
        translation: "Completamente diferente",
        level: "A2",
        definition: "Not alike at all.",
        examSentence: "They are completely different.",
      },
      {
    ...
    Collocations: [
      {
        ...
        level: "A2",
        definition: "Things you do every day.",
        examSentence: "Exercise is part of my daily routine.",
      },
      {
        word: "Damaged reputation",
      ...
      },
      {
        ...
        level: "B1",
        definition: "No exit/No future.",
        examSentence: "It's a dead end job.",
      },
      {
        word: "Deadly weapon",
        ipa: "/ˈdɛdli ˈwɛpən/",
      ...
      {
        word: "Definite answer",
        ipa: "/ˈdɛfɪnɪt ˈɑːnsər/",
        translation: "Respuesta definitiva",
        level: "B2",
        definition: "Clear yes or no.",
        examSentence: "I need a definite answer.",
      },
      {
      ...
      {
        word: "Deny an accusation",
        ipa: "/dɪˈnaɪ ən ˌækjʊˈzeɪʃən/",
        translation: "Negar una acusación",
        level: "C1",
        definition: "Say it isn't true.",
        examSentence: "He denied the accusation.",
      },
      {
        word: "Depart from tradition",
      ...
      {
        word: "Divide attention",
        ipa: "/dɪˈvaɪd əˈtɛnʃən/",
        translation: "Dividir la atención",
        level: "C1",
        definition: "Focus on two things.",
        examSentence: "Don't divide your attention.",
      },
      {
        word: "Do a favor",
        ipa: "/duː ə ˈfeɪvər/",
      ...
      },
      {
        word: "Drink heavily",
        ipa: "/drɪŋk ˈhɛvɪli/",
        translation: "Beber mucho",
        level: "B2",
        definition: "Consume lots of alcohol.",
        examSentence: "He used to drink heavily.",
      },
      {
        word: "Drive carefully",
        ipa: "/draɪv ˈkɛərfʊli/",
      ...
      {
        word: "Drop a subject",
        ipa: "/drɒp ə ˈsʌbdʒɪkt/",
        translation: "Dejar un tema",
        level: "C1",
        definition: "Stop talking about it.",
        examSentence: "Let's drop the subject.",
      },
      {
        word: "Drug abuse",
        ipa: "/drʌɡ əˈbjuːs/",
      ...
      },
      {
        word: "Dull moment",
        ipa: "/dʌl ˈmoʊmənt/",
        translation: "Momento aburrido",
        level: "C1",
        definition: "Boring time (usually negative).",
        examSentence: "Never a dull moment here.",
      },
    ],
  },
  E: {
    Collocations: [
      {
        word: "Early days",
        ipa: "/ˈɜːrli deɪz/",
        translation: "Primeros días",
        level: "B2",
        definition: "Too soon to say.",
        examSentence: "It's early days yet.",
      },
      {
        word: "Earn a living",
        ipa: "/ɜːrn ə ˈlɪvɪŋ/",
        translation: "Ganarse la vida",
        level: "B1",
        definition: "Make money for life.",
        examSentence: "It's hard to earn a living.",
      },
      {
        word: "Earn respect",
        ipa: "/ɜːrn rɪˈspɛkt/",
      ...
      },
      {
        word: "Easy money",
        ipa: "/ˈiːzi ˈmʌni/",
        translation: "Dinero fácil",
        level: "B1",
        definition: "Cash with little work.",
        examSentence: "He wanted easy money.",
      },
      {
        word: "Eat healthy",
        ipa: "/iːt ˈhɛlθi/",
      ...
      },
      {
        ...
        translation: "Superar expectativas",
        level: "C1",
        definition: "Do better than hoped.",
        examSentence: "The results exceeded expectations.",
      },
      {
        word: "Excellent choice",
        ipa: "/ˈɛksələnt tʃɔɪs/",

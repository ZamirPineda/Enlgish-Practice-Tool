...
{
  id: "b2-14",
  sentence: "Provided that legal approves the draft we can publish it tomorrow.",
  targetConnector: "provided that",
  acceptedAnswers: [
...
{
  id: "c1-17",
  sentence: "Seeing that the vendor missed two milestones we reopened the tender.",

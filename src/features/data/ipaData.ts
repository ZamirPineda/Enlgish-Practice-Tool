...
export const ipaData: IPASound[] = [
    ...
    connectedSpeech: [
      {
        exact: "She is here",
        fast: "She's here",
        context: "Pronoun contraction",
      },
      {
        exact: "I see it",
        fast: "I see_it",
        context: "Linking /j/ sound: /aɪ siːjɪt/",
      },
    ],
    similar: ["ɪ"],
  },
    ...
    connectedSpeech: [
      {
        exact: "Good at",
        fast: "Goo-dat",
        context: "Linking consonant to vowel",
      },
    ],
    similar: ["uː"],
  },
    ...
    connectedSpeech: [
      {
        exact: "Who is it?",
        fast: "Who-wiz-it?",
        context: "Linking /w/ sound: /huːwɪzɪt/",
      },
    ],
    similar: ["ʊ"],
  },
  {
    ...
    category: "Vowel",
    description:
      'The "flat A" sound in "cat" or "black". Higher and wider than the Spanish A.',
    mouthPosition:
      "Open mouth wide, tongue flat and forward, corners of mouth pulled back.",
    examples: [
    ...
    connectedSpeech: [
      {
        exact: "That apple",
        fast: "Tha-tapple",
        context: "Linking: T becomes a light D or glottal stop",
      },
    ],
    similar: ["ʌ", "eɪ"],
  },
    ...
    connectedSpeech: [
      {
        exact: "But I",
        fast: "Bu-daɪ",
        context: "Flap T: T sounds like a fast Spanish R",
      },
    ],
    similar: ["æ", "ə"],
  },
    ...
    connectedSpeech: [
      {
        exact: "Her office",
        fast: "He-roffice",
        context: "Linking R: The R connects to the next vowel",
      },
    ],
  },
  {
    ...
    connectedSpeech: [
      {
        exact: "To the store",
        fast: "t'th' store",
        context: "Vowel reduction in 'to' and 'the'",
      },
    ...
    connectedSpeech: [
      {
        exact: "Stay up",
        fast: "Stay-yup",
        context: "Linking /j/ between vowels",
      },
    ],
    similar: ["æ"],
  },
    ...
    connectedSpeech: [
      {
        exact: "Go out",
        fast: "Go-wout",
        context: "Linking /w/ between vowels",
      },
    ],
  },
  ...
  // --- CONSONANTS ---
  {
    ...
    mouthPosition:
      "Press lips together, then release with a burst. No vibration.",
    examples: [
  ...
  },
  {
    ...
    category: "Consonant",
    description:
      'The nasal sound at the end of "sing" or "long". No "G" sound!',
    mouthPosition:
      "Back of tongue touches the roof of the mouth. Air goes through nose.",
    examples: [
    ...
    connectedSpeech: [
      {
        exact: "Singing a",
        fast: "Si-ŋi-ŋuh",
        context: "Linking nasal to vowel",
      },
    ],
  },
  {
    ...
    connectedSpeech: [
      {
        exact: "Meet you",
        fast: "Mee-chu",
        context: "Yod-coalescence: /t/ + /j/ becomes /tʃ/",
      },
      {
        exact: "What you doing",
        fast: "Whatchu doin'",
        context: "Informal reduction",
      },
    ],
    similar: ["ʃ", "dʒ"],
  },
    ...
    connectedSpeech: [
      {
        exact: "Did you",
        fast: "Di-dju",
        context: "Yod-coalescence: /d/ + /j/ becomes /dʒ/",
      },

...
},
{
  ...
  mode: "conditional",
  expectedSentence: "If I save enough money this month I will buy a new headset.",
...
},
{
  ...
  mode: "conditional",
  expectedSentence: "If she finishes the design review today she will send the revised mockups tonight.",
  tags: ["Design", "Work"],
  level: "B1",
},
{
...
},
{
  ...
  mode: "question",
  expectedSentence: "Did the procurement team renegotiate the contract last week?",
...
},
{
  ...
  mode: "negative",
  expectedSentence: "The dashboard does not highlight the most critical anomalies.",
  tags: ["Data", "Analysis"],
  level: "B2",
},
{
  id: "b2-17",
  baseSentence: "We complete the migration before the seasonal campaign starts.",
  mode: "conditional",
  expectedSentence: "If we complete the migration before the seasonal campaign starts we will avoid a major bottleneck.",
...
{
  id: "c1-17",
  baseSentence: "The compliance team identified the inconsistency before the audit.",
  mode: "question",
  expectedSentence: "Did the compliance team identify the inconsistency before the audit?",
...
},
{
  ...
  mode: "conditional",
  expectedSentence: "If the committee had reviewed the evidence carefully it would have reached a more balanced conclusion.",
  tags: ["Research", "Decision Making"],
  level: "C1",
},
{
  id: "c1-19",
  baseSentence: "The vendor discloses all material assumptions in the appendix.",
  mode: "negative",
  expectedSentence: "The vendor does not disclose all material assumptions in the appendix.",

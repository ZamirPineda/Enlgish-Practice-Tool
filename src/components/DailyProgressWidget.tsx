          ...
          {weeklyConsistency.tiers.map((tier) => (
            ...
            >
              ...
              <button
                ...
                aria-label={
                  tier.claimed
                    ? `Claimed: ${tier.title} tier, +${tier.rewardXp} XP`
                    : tier.eligible
                      ? `Claim Reward: ${tier.title} tier, +${tier.rewardXp} XP`
                      : `Locked: ${tier.title} tier, +${tier.rewardXp} XP (Requires ${tier.requiredDays} active days)`
                }
              >
                {tier.claimed
                  ? "Claimed"

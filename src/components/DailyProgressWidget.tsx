          ...
          {weeklyConsistency.tiers.map((tier) => (
            ...
            >
              ...
              <button
                ...
                aria-label={
                  tier.claimed
                    ? `Weekly ${tier.title} reward claimed`
                    : tier.eligible
                      ? `Claim weekly ${tier.title} reward of ${tier.rewardXp} XP`
                      : `Locked: Play ${tier.requiredDays} days to unlock weekly ${tier.title} reward`
                }
              >
                {tier.claimed
                  ? "Claimed"

          ...
          aria-label={
            sessionSummary.rewardClaimed
              ...
              : sessionSummary.rewardEligible
                ...
                : "Complete 2 sessions with 70%+ accuracy to unlock daily reward"
          }
        >
          ...
          {weeklyConsistency.tiers.map((tier) => (
            ...
            >
              ...
              <button
                ...
                aria-label={
                  tier.claimed
                    ? `${tier.title} reward claimed`
                    : tier.eligible
                      ? `Claim ${tier.title} reward: ${tier.rewardXp} XP`
                      : `Locked: requires ${tier.requiredDays} days active to unlock ${tier.title}`
                }
              >
                {tier.claimed
                  ? "Claimed"

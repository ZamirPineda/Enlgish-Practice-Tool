        ...
        <button
          ...
          aria-label={
            sessionSummary.rewardClaimed
              ...
              : sessionSummary.rewardEligible
                ? `Claim your daily reward of ${sessionSummary.rewardXp} XP`
                : "Play 2 sessions with 70%+ accuracy to unlock daily reward"
          }
              ...
              <button
                ...
                aria-label={
                  tier.claimed
                    ...
                    : tier.eligible
                      ? `Claim weekly reward ${tier.title} for ${tier.rewardXp} XP`
                      : `Weekly reward ${tier.title} locked. Requires ${tier.requiredDays} active days.`
                }

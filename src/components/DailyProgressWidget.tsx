        ...
        <button
          ...
          aria-label={
            sessionSummary.rewardClaimed
              ...
              : !sessionSummary.rewardEligible
                ? "Play 2 sessions with 70% or more accuracy to unlock daily reward"
                : `Claim +${sessionSummary.rewardXp} XP daily reward`
          }
        >
          ...
          {weeklyConsistency.tiers.map((tier) => (
            ...
            >
              ...
              <button
                ...
                aria-label={
                  tier.claimed
                    ? `${tier.title} tier reward already claimed`
                    : !tier.eligible
                      ? `Complete ${tier.requiredDays} active days to unlock ${tier.title} tier reward`
                      : `Claim +${tier.rewardXp} XP for completing ${tier.title} tier`
                }
              >
                {tier.claimed
                  ? "Claimed"

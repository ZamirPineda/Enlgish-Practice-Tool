...
const MathFlashCard: React.FC<MathFlashCardProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 h-full max-w-2xl mx-auto">
      ...
      {/* Card Container */}
      <div
        className="w-full relative min-h-[400px] md:min-h-[500px] cursor-pointer perspective-1000 group focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-accent rounded-2xl transition-shadow"
      ...
      >
        <span className="sr-only" lang="es">
          Tarjeta de memoria matemática. Presiona Espacio o Enter para girar,
          Flecha Derecha para la siguiente, Flecha Izquierda para la anterior, y
          Escape para salir.
        </span>
        <div

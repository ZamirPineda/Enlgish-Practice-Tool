...
const MathFlashCard: React.FC<MathFlashCardProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 h-full max-w-2xl mx-auto">
      ...
      {/* Card Container */}
      <div
        className="w-full relative min-h-[400px] md:min-h-[500px] cursor-pointer perspective-1000 group focus-visible:ring-2 focus-visible:outline-none rounded-2xl"
      ...
      >
        <span className="sr-only" lang="es">
          Tarjeta de estudio. Presione Enter o Espacio para girar.
        </span>
        <div

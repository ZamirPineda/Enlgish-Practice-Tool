  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      if (e.key === "ArrowRight") {
        ...
        // If we are focused on the card itself, let its onKeyDown handle it
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 h-full max-w-2xl mx-auto">
      ...
      <div
        ...
        aria-label={
          isFlipped
            ? "Respuesta, presione Enter o Espacio para voltear"
            : "Pregunta, presione Enter o Espacio para voltear"
        }

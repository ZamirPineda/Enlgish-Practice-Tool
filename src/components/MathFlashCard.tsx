...
const MathFlashCard: React.FC<MathFlashCardProps> = ({
  ...
  useEffect(() => {
    const handleGlobalKeyDown = (e: KeyboardEvent) => {
      // Don't hijack if user is typing in an input or focusing another button
      ...
      // Allow default interaction on focused buttons to work (prevent double firing)
      if (
        activeElement &&
  ...
  }, [handleFlip, handleNext, handlePrev, onExit]);
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 h-full max-w-2xl mx-auto">
      ...
      {/* Card Container */}
      <div
        className="w-full relative min-h-[400px] md:min-h-[500px] cursor-pointer perspective-1000 group focus-visible:ring-2 focus-visible:ring-accent rounded-2xl outline-none"
      ...
      >
        <span className="sr-only">
          Flashcard. Press Space or Enter to flip.
        </span>
        <div

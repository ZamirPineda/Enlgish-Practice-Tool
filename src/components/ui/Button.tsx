...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  success:
    "bg-success hover:bg-success-hover text-slate-900 border border-transparent shadow-md shadow-success/20 hover:shadow-xl hover:shadow-success/40 hover:-translate-y-0.5",
};

        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <Card elevated>
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div>
                <h1 className="text-3xl sm:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-fuchsia-400 tracking-tight">
                  Diplomatic Reviewer
                </h1>
                <p className="text-text-secondary text-sm mt-1">
                  Refactoriza el lenguaje tóxico hacia feedback profesional y
                  constructivo.
                </p>
              </div>
              <div className="text-xs font-bold uppercase tracking-widest text-text-secondary">
                Situación {roundIndex + 1} / {rounds.length}
              </div>
              <div className="w-full sm:w-auto flex-1 max-w-xs">
                ...
                <div className="w-full h-2 bg-surface-2 rounded-full overflow-hidden shadow-inner border border-border">
                  <div
                    ...
                    style={{
                      width: `${(timeLeft / ROUND_TIME_SECONDS) * 100}%`,
                    }}
                  />
                </div>
              </div>
          ...
          <Card className="space-y-6">
            ...
            <div className="space-y-3">
              {currentOptions.map((opt, index) => {
                ...
                let btnVariant: "secondary" | "success" | "danger" =
                  "secondary";
              ...
              >
                <div className="space-y-2">
                  {isCorrect ? (
                    ...
                    <>
                      <p>
                        ⏰ Tiempo agotado. Siempre hay que mantener la calma.
                      </p>

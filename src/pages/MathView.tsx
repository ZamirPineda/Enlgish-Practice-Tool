        ...
        >
          <button
            ...
            className={`px-4 py-2 min-h-[40px] rounded-lg font-bold text-sm transition-all active:scale-[0.98] whitespace-nowrap ${
              activeTab === "calculus"
                ? "bg-sky-400 text-slate-900 shadow-lg shadow-sky-900/50"
          ...
          <button
            ...
            className={`px-4 py-2 min-h-[40px] rounded-lg font-bold text-sm transition-all active:scale-[0.98] whitespace-nowrap ${
              activeTab === "geometry"
                ? "bg-purple-400 text-slate-900 shadow-lg shadow-purple-900/50"
                : "bg-surface-2 text-text-muted hover:bg-surface-hover hover:text-text-primary"
            }`}
          >
            📐 Geometría
          ...
          <button
            ...
            className={`px-4 py-2 min-h-[40px] rounded-lg font-bold text-sm transition-all active:scale-[0.98] whitespace-nowrap ${
              activeTab === "algebra"
                ? "bg-emerald-400 text-slate-900 shadow-lg shadow-emerald-900/50"
                : "bg-surface-2 text-text-muted hover:bg-surface-hover hover:text-text-primary"
            }`}
          >
            🧮 Álgebra

              ...
              <div className="mt-6 flex gap-2">
                ...
                {onboardingStep < ONBOARDING_STEPS.length - 1 ? (
                  <button
                    ...
                    className="ml-auto px-4 py-2 rounded-lg bg-accent hover:bg-accent-hover text-slate-950 text-sm font-black transition-colors"
                  >
                    Next
                  </button>
                ) : (
                  <button
                    onClick={closeOnboarding}
                    className="ml-auto px-4 py-2 rounded-lg bg-success hover:bg-success-hover text-slate-950 text-sm font-black transition-colors"
                  >
                    Let’s go
                  </button>
                )}
